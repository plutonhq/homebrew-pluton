...
[Pluton](https://usepluton.com) is an open-source, self-hosted backup automation software.
...
Pluton is licensed under [Apache-2.0](https://github.com/plutonhq/pluton/blob/main/LICENSE).
